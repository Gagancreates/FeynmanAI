...
export async function handleTTS(request: Request, env: Env): Promise<Response> {
  ...
  const response = await fetch(
    `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-tts:generateContent?key=${env.GOOGLE_API_KEY}`,
    {
      method: 'POST',
...
*Built for Feynman AI Hackathon — Feb 2026*
